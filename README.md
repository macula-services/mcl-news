...
The service boots, joins the mesh and answers `/health` on 8498. It
...
| `MCL_HEALTH_PORT` | `8498` | Health endpoint. Host networking makes a collision a silent bind failure, so check the host before changing.  |
